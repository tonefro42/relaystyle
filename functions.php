...
function renderFileSource( $content ) {
	if ( $content != '' ) {
		...
		echo '<button type="button" class="sg-btn sg-btn-primary sg-btn-sm sg-btn--source">View Source</button>';
		//echo '<a class="sg-btn sg-btn-sm sg-btn-cancel sg-btn--top" href="#top">Back to Top</a>';
		echo '</div>';
